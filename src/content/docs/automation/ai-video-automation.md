...
- **Meeting recordings**: Auto-transcribe + summarize
- **Content creation**: Extract highlight clips
- **Accessibility**: Add subtitles to all videos
- **Video library**: Searchable transcripts
- **Training materials**: Generate summaries
