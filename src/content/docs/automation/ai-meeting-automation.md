...
## Complete Meeting Automation Workflow
...
**Automated Meeting Workflow**:

1. **Trigger**: Google Meet/Zoom recording uploaded
2. **OpenAI**: Transcribe with Whisper
3. **OpenAI**: Generate summary + action items
4. **Asana**: Create tasks for action items
5. **Google Docs**: Create meeting minutes document
6. **Gmail**: Send minutes to attendees
7. **Slack**: Post summary in team channel
