...
**Ataque**: La entrada del usuario manipula el comportamiento de la IA
...
**Defensa**: Validación de entrada y aislamiento de prompts
...
**Riesgo**: Datos sensibles en prompts o entrenamiento

**Defensa**: Enmascaramiento de datos
...
**Ataque**: Eludir pautas de seguridad

**Defensa**: Filtrado de salida
...
- Usar prompts separados de sistema/usuario
- Implementar limitación de tasa
- Registrar eventos de seguridad
- Cifrar datos en reposo
- Auditorías de seguridad regulares
- Rotación de claves API
- Consentimiento del usuario para uso de datos

❌ **No hacer**:
- Confiar ciegamente en la entrada del usuario
- Almacenar claves API en código
- Omitir filtrado de salida
- Ignorar regulaciones de privacidad
