...
## OCR de Documentos con Vision AI
...
## Flujo de Trabajo de Automatización n8n

**Pipeline de Procesamiento de Facturas**:

1. **Trigger de Email**: Monitorear facturas en la bandeja de entrada
2. **Extraer Adjuntos**: Obtener archivos PDF/imagen
3. **OpenAI Vision**: Extraer datos de factura
4. **Validación**: Verificar reglas de negocio
5. **Nodo de Decisión**: Auto-aprobar o enviar para revisión
6. **QuickBooks**: Crear entrada de factura
7. **Slack**: Notificar al equipo de cuentas por pagar
8. **Google Sheets**: Registrar todas las facturas procesadas
