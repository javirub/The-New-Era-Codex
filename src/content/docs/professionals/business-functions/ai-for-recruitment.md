...
**Don't**:
❌ Rely solely on AI decisions
❌ Use unaudited AI tools
❌ Collect unnecessary data
❌ Hide AI usage from candidates
...
❌ **Over-automation**: Keep human touch points
❌ **Black box AI**: Understand how tools make decisions
❌ **Ignoring bias**: Regularly audit for fairness
❌ **Poor candidate experience**: Don't sacrifice experience for efficiency
❌ **No change management**: Train recruiters properly
